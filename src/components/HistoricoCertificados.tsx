...
const HistoricoCertificados: React.FC<HistoricoCertificadosProps> = ({
  ...
  if (certificados.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center py-10 sm:py-12 text-center px-2">
          ...
          >
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="min-w-0 flex-1">
                <p className="text-sm font-medium text-foreground break-words line-clamp-2">{cert.nomeArquivo}</p>
              ...
              <div className="flex shrink-0 items-center gap-1.5 sm:gap-2">
                <Badge variant="outline" className={`text-[10px] sm:text-xs ${status.className}`}>
            ...
            {cert.status === "aprovado" && (
              <div className="mt-2.5 sm:mt-3 ml-0 sm:ml-[52px] rounded-md bg-success/5 border border-success/20 p-2.5 sm:p-3 space-y-1">
            ...
            {cert.status === "rejeitado" && (
              <div className="mt-2.5 sm:mt-3 ml-0 sm:ml-[52px] rounded-md bg-destructive/5 border border-destructive/20 p-2.5 sm:p-3 space-y-1">
            ...
            {cert.status === "pendente" && (
              <div className="mt-2.5 sm:mt-3 ml-0 sm:ml-[52px] rounded-md bg-warning/5 border border-warning/20 p-2.5 sm:p-3">
            ...
            {cert.observacaoAluno && (
              <p className="mt-2 ml-0 sm:ml-[52px] text-xs text-muted-foreground italic break-words line-clamp-2">
                "{cert.observacaoAluno}"
              </p>
            )}
          </div>
